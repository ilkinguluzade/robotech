...
var bounds1 = new L.LatLngBounds(new L.LatLng(54.559322, -5.767822), new L.LatLng(56.1210604, -3.02124));
...
var map = L.map("Moov_Canvas", { preferCanvas: true }).setView([50.5, 30.51], 15).addLayer(osm);
...
var circle = L.circle([51.508, -0.11], 500, { color: "#f03", opacity: 0.7 }).bindPopup("I am a circle.").addTo(map);
